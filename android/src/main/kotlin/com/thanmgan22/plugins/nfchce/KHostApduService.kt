...
class KHostApduService : HostApduService() {
    ...
    //If the file does not exist, assign the default value 'DEFAULT_CONTENT'
...
//            }
            ...
            Log.i("onStartCommand()", "content: " + content)
...
//        return Service.START_STICKY
    ...
    override fun processCommandApdu(commandApdu: ByteArray, extras: Bundle?): ByteArray? {
        ...
        if(NDEF_MESSAGE == "DEFAULT_CONTENT") {
            Log.i(TAG, "Still not init content default is served");
            return null
        }
    ...
    companion object {
        ...
        fun readNdefMessageFromFile(context: Context): String? {
            var ndefMessage: String? = "DEFAULT_CONTENT"
